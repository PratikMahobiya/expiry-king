...
class IndexAdmin(ExportActionMixin, admin.ModelAdmin):
    list_display = ('exchange', 'index', 'index_symbol', 'pivot', 'r1', 'r2', 'r3', 's1', 's2', 's3', 'target', 'stoploss', 'fixed_target', 'min_price', 'max_price', 'expiry_date', 'trailing_target', 'chain_strike_price_diff', 'angel_token', 'is_active')
